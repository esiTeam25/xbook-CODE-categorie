...
public class cfragment3 extends Fragment {
    ...
    public Query get(){
        if (key== null ) {
            ...
            return FirebaseFirestore.getInstance().collection("books").whereEqualTo("categorie" , "categorie3").limit(5) ;
        }
        else {
            return FirebaseFirestore.getInstance().collection("books").whereEqualTo("categorie" , "categorie3").startAfter(key).limit(5);
        }
    }
