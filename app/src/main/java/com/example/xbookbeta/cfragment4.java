...
public class cfragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_cfragment4, container, false);
    ...
    public Query get(){
        if (key== null ) {
            ...
            return FirebaseFirestore.getInstance().collection("books").whereEqualTo("categorie" , "categorie4").limit(5) ;
        }
        else {
            return FirebaseFirestore.getInstance().collection("books").whereEqualTo("categorie" , "categorie4").startAfter(key).limit(5);
        }
    }
