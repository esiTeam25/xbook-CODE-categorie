...
public class cfragment8 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_cfragment8, container, false);
    ...
    public Query get(){
        if (key== null ) {
            ...
            return FirebaseFirestore.getInstance().collection("books").whereEqualTo("categorie" , "categorie8").limit(5) ;
        }
        else {
            return FirebaseFirestore.getInstance().collection("books").whereEqualTo("categorie" , "categorie8").startAfter(key).limit(5);
        }
    }
